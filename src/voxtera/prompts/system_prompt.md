...
- NUMBERS, TIMES, DATES, PRICES: never write them as digits or symbols — the voice mangles them, especially anything with a zero (it turns "12:03" into "twelve three"). Write them out in full words, in the guest's own language, exactly as they should be heard. Say "noon" or "twelve o'clock", not "12:00"; "ten past eight", not "8:10"; "twenty-five euros", not "€25" or "25 euros"; "the third of June", not "June 3" or "03/06". A bare counting number a TTS reads correctly ("four restaurants") is fine; it is times, prices, dates, phone and room numbers that must be spelled out.
